    ...
    <section id="about">
        <div className="bg-white mx-auto flex px-20 py-20 md:flex-row flex-col items-center">
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                ...
                />
                <p className="mb-8 text-slate-500 text-xl md:text-2xl leading-loose">
                    I'm a sophomore at Brown University studying Computer Science.
                    <br/>
                    I'm particularly interested in the intersection of technology, design, and business, and creating user-centered solutions for businesses.
                </p>
            </div>
