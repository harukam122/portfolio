...
export default function Navbar() {
  return (
    <header className="bg-white md:sticky top-0 z-10">
      <div className="container mx-auto flex flex-wrap px-5 py-7 flex-col md:flex-row items-center">
        <nav className="md:mr-auto flex flex-wrap items-center justify-between">
            <div>
